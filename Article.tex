...
% Creation: may. 2018
% Modifications: may. 2018, june 2018, july 2018, aug. 2018
...
\begin{abstract}
  ...
  nonsymmetric operad over one binary generator. In the linear setting,
  we show that the set of these quotients admits a lattice structure and
  we show the Grassmann formula for this lattice. In the nonlinear
  setting, we define comb associative operads, indexed by nonegative
  integres, as generalizations of the associative operad. We show that
  the set of comb associative operads admits a lattice structure,
  isomoprhic to the lattice of nonnegative integers equipped with the
  division order, and we provide a finite convergent presentation for the
  comb associative operad corresponding to $3$. Finally, we study
  quotients of the magmatic operad by one relation of degree $3$ by
  studying their Hilbert series and providing combinarotial realizations.
\end{abstract}
